    ...
    return (
      <BrowserRouter>
        <div>
          ...
          <Route
            path="/searchedjobs/:criterion/:lat/:long"
          ...
          <Route
            path="/applicantconnection"
            component={ApplicantConnection}
            exact
          />
          <Route path="/recruiterhome" component={RecruiterHome} exact />
          <Route
            path="/recruiterconnection"
            component={RecruiterConnection}
            exact
          />
          ...
          <Route
            path="/jobapplicant/:jobId"
            component={JobApplicantsHome}
            exact
          />
