...
class JobDetailedView extends Component {
  ...
  async easy_apply() {
    if (
      ...
      this.state.applicant_email &&
      this.state.applicant_phone &&
      this.state.applicant_resume_name
    ) {
      let data = {
      ...
      try {
        let ret = await api(
          "POST",
          "jobs/" + this.state.job_id + "/easyApply",
          data
        );
    ...
    try {
      ...
      if (ret.status >= 200 && ret.status < 300) {
        this.setState({
          ...
          applicantHeading:
            "Former Systems Engineer | Masters in Software Engineering|",
      ...
      easyApplyButton = (
        <div class="child inline-block-child">
          <button
            ...
            data-toggle="modal"
            data-target="#easyApplyModal"
            onClick={this.getApplicant}
          >
            Easy Apply
          </button>
        </div>
        ...
        <div className="row left-job-detail">
          <div className="col-md-3 left-job-detail-image">
            <img
              ...
              class="img-fluid job-detail-image"
              alt="LinkedIn"
            />
          </div>
          ...
          <div
            ...
            tabindex="-1"
            role="dialog"
            aria-labelledby="easyApplyModalLabel"
            aria-hidden="true"
          >
            <div className="modal-dialog" role="document">
              <div className="modal-content">
                <div className="modal-header">
                  <h5 className="modal-title" id="easyApplyModalLabel">
                    Easy Apply
                  </h5>
                  <button
                    type="button"
                ...
                <div className="modal-body">
                  <div className="row left-job-detail">
                    <div className="col-md-3 left-job-detail-image">
                      <img
                        src=""
                        class="img-fluid job-card-image-easy-apply"
                        alt=""
                      />
                    </div>
                    <div className="col-md-8 left-job-detail-desc">
                      <div>
                        <label className="heading-company">
                          {this.state.applicantFname}{" "}
                          {this.state.applicantLname}
                        </label>
                      </div>
                      <div>
                      ...
                      <div>
                        <Link to="/profile">
                          <button
                            type="button"
                            class="btn btn-link"
                            onClick={() => $("#easyApplyModal").modal("hide")}
                          >
                            Review your profile
                          </button>
                        </Link>
                  ...
                  <form id="easy_apply_form">
                    <label id="work-exp-form"> Email:</label>
                    <br />
                    <input
                      type="email"
                    ...
                    />
                    <br />
                    <label id="work-exp-form"> Phone:</label>
                    <br />
                    <input
                      type="tel"
                      id="work-exp-form"
          ...
          <div className="col-md-9 left-job-detail-desc">
            <div className="heading-company">{this.state.title}</div>
            <div className="heading-location">
              {this.state.company} &#9670; {this.state.address.city},{" "}
              {this.state.address.country}
            </div>

            <div className="heading-location">
              <label style={{ color: "green", fontSize: "12px" }}>
                New &#9670;
              </label>
              &nbsp;
              <label style={{ fontSize: "12px" }}>
                Posted {this.state.time_diff} ago
              </label>
            </div>
            <div className="heading-location-button">
              <img src={Watch} style={{ width: "4%" }} />
              &nbsp;
              <label style={{ paddingTop: "1%", fontSize: "12px" }}>
...
function mapStateToProps(state) {
  ...
  return { jobs: state.searched_jobs.jobs, activeID: state.active_id.activeID };
}
